            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <a href="{{ route('currencies.create') }}" class="btn btn-primary">Создать валюту <i class="fas fa-plus ml-2"></i></a>
                    </div>
                ...
                <div class="row">
                    ...
                    <table class="table">
                        ...
                        @forelse($currencies as $currency)
                            <tr data-entry-id="{{ $currency->id }}">
                                ...
                                <td class="action-block">
                                    <div class="mrt-5">
                                        <a class="btn btn-primary btn-actions" href="{{ route('currencies.edit',$currency->id) }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">{{ __('Нет валюты') }}</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
