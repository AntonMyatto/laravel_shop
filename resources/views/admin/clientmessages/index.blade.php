                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="nav nav-tabs nav-client">
                            <li class=" btn">
                                <a data-toggle="tab" href="#description" class="btn active">Все сообщения <span
                                        class=" text-light p-1">{{$cli_messages_count}}</span></a>
                            </li>
                            <li class="btn">
                                <a href="{{ route('clientmessages.read') }}" class="btn">Прочитанные <span
                        ...
                        <div class="tab-pane active" id="description">
                            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                    @forelse($cli_messages as $client)
                                ...
                                <table class="table">
                                    ...
                                    @forelse($cli_read_messages as $client)
                                        <tr data-entry-id="{{ $client->id }}">
                                            ...
                                            <td id="status">
                                                @if($client->visited == 0)
                                                    <span class="text-white bg-danger p-1 noread" style="border-radius: 10px">Непросмотрено</span>
                                                @else
                                                    <span class="text-white bg-success p-1 read" style="border-radius: 10px">Просмотрено</span>
                                                @endif
                                            </td>
                        ...
                        <div class="tab-pane" id="opinion">
                            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                    @forelse($cli_no_read_messages as $client)
                                        <tr data-entry-id="{{ $client->id }}">
...
<script type="text/javascript">
    ...
    */
    function showDetail(id) {
        ...
        let statusBlock = tarPar.siblings('#status');

        if(statusBlock.children().hasClass('noread')){
        statusBlock.html('<span class="text-white bg-success p-1 read" style="border-radius: 10px">Просмотрено</span>');
        }else{
        alert('прочитано');
        }
