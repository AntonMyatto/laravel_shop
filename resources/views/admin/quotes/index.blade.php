            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <a href="{{ route('quotes.create') }}" class="btn btn-primary">Создать цитату <i class="fas fa-plus ml-2"></i></a>
                    </div>
                ...
                <div class="row">
                    ...
                    <table class="table">
                        ...
                        @forelse($quotes as $quote)
                            <tr data-entry-id="{{ $quote->id }}">
                                ...
                                <td class="action-block">
                                    <div class="mrt-5">
                                        <a class="btn btn-primary btn-actions" href="{{ route('quotes.edit',$quote->id) }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">{{ __('Нет цитат') }}</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
