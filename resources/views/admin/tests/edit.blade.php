            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6 mt-2 mb-2 text-dark">
                        <h2>Обновление теста</h2>
                    </div>

                    <div class="col-lg-6 mt-2 mb-2 justify-content-end d-flex">
                        <a href="{{ route('tests.index') }}" class="btn btn-primary" style="max-width:180px;height:40px;">Вернуться</a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Название" value="{{$test->name}}">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($test->type == "course")
                                        <select name="type" id="" class="form-control">
                                            <option value="course" selected>Для курса</option>
                                            <option value="begin">Начальный</option>
                                        </select>
                                    @else
                                        <select name="type" id="" class="form-control">
                                            <option value="course">Для курса</option>
                                            <option value="begin" selected>Начальный</option>
                                        </select>
                                    @endif
                                </div>
                            </div>
