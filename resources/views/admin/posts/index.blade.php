            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <a href="{{ route('posts.create') }}" class="btn btn-primary">Создать пост <i class="fas fa-plus ml-2"></i></a>
                    </div>
                </div>
                    ...
                    <table class="table">
                        ...
                        @forelse($posts as $post)
                            <tr data-entry-id="{{ $post->id }}">
                                ...
                                <td><img src="{{ Storage::url($post->img) }}" alt="" class="img-fluid img-record"></td>
                                <td><a>Смотреть</a></td>
                                <td class="action-block">
                                    <div class="mrt-5">
                                        <a class="btn btn-primary btn-actions" href="{{ route('posts.edit',$post->id) }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">{{ __('Нет постов') }}</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
